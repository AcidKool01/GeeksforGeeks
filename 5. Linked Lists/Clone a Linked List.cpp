...
Node *copyList(Node *head) {
    // Your code here
    // copy the whole link list and connect them to each other.
    // like if link list is 1 3 4 5 == modify it to 1 1 3 3 4 4 5 5.
    ...
    // set the random pointers accordingly
